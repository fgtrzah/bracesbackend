...
/* tslint:disable */
/* eslint-disable */
import type { rate_limit_overview } from '../models/rate_limit_overview';
...
export class RateLimitService {
     ...
     * @returns rate_limit_overview Response
     * @throws ApiError
     */
    public static rateLimitGet(): CancelablePromise<rate_limit_overview> {
