...
import type { code_scanning_alert } from '../models/code_scanning_alert';
import type { code_scanning_alert_dismissed_comment } from '../models/code_scanning_alert_dismissed_comment';
import type { code_scanning_alert_dismissed_reason } from '../models/code_scanning_alert_dismissed_reason';
import type { code_scanning_alert_instance } from '../models/code_scanning_alert_instance';
import type { code_scanning_alert_items } from '../models/code_scanning_alert_items';
import type { code_scanning_alert_set_state } from '../models/code_scanning_alert_set_state';
import type { code_scanning_alert_severity } from '../models/code_scanning_alert_severity';
import type { code_scanning_alert_state_query } from '../models/code_scanning_alert_state_query';
import type { code_scanning_analysis } from '../models/code_scanning_analysis';
import type { code_scanning_analysis_commit_sha } from '../models/code_scanning_analysis_commit_sha';
import type { code_scanning_analysis_deletion } from '../models/code_scanning_analysis_deletion';
import type { code_scanning_analysis_sarif_file } from '../models/code_scanning_analysis_sarif_file';
import type { code_scanning_analysis_sarif_id } from '../models/code_scanning_analysis_sarif_id';
import type { code_scanning_analysis_tool_guid } from '../models/code_scanning_analysis_tool_guid';
import type { code_scanning_analysis_tool_name } from '../models/code_scanning_analysis_tool_name';
import type { code_scanning_codeql_database } from '../models/code_scanning_codeql_database';
import type { code_scanning_default_setup } from '../models/code_scanning_default_setup';
import type { code_scanning_default_setup_update } from '../models/code_scanning_default_setup_update';
import type { code_scanning_default_setup_update_response } from '../models/code_scanning_default_setup_update_response';
import type { code_scanning_organization_alert_items } from '../models/code_scanning_organization_alert_items';
import type { code_scanning_ref } from '../models/code_scanning_ref';
import type { code_scanning_sarifs_receipt } from '../models/code_scanning_sarifs_receipt';
import type { code_scanning_sarifs_status } from '../models/code_scanning_sarifs_status';
...
export class CodeScanningService {
     ...
     * @throws ApiError
     */
    public static codeScanningListAlertsForOrg(
        org: string,
        toolName?: code_scanning_analysis_tool_name,
        toolGuid?: code_scanning_analysis_tool_guid,
        before?: string,
        after?: string,
        page: number = 1,
        perPage: number = 30,
    ...
    ): CancelablePromise<Array<code_scanning_organization_alert_items>> {
     ...
     * @throws ApiError
     */
    public static codeScanningListAlertsForRepo(
        owner: string,
        repo: string,
        toolName?: code_scanning_analysis_tool_name,
        toolGuid?: code_scanning_analysis_tool_guid,
        ...
        state?: code_scanning_alert_state_query,
        severity?: code_scanning_alert_severity,
    ): CancelablePromise<Array<code_scanning_alert_items>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningGetAlert(
        owner: string,
        repo: string,
        alertNumber: alert_number,
    ): CancelablePromise<code_scanning_alert> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningUpdateAlert(
        owner: string,
        repo: string,
        alertNumber: alert_number,
        requestBody: {
     ...
     * @throws ApiError
     */
    public static codeScanningListAlertInstances(
        owner: string,
        repo: string,
        alertNumber: alert_number,
        page: number = 1,
        perPage: number = 30,
        ref?: code_scanning_ref,
    ): CancelablePromise<Array<code_scanning_alert_instance>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningListRecentAnalyses(
        owner: string,
        repo: string,
        toolName?: code_scanning_analysis_tool_name,
        toolGuid?: code_scanning_analysis_tool_guid,
        ...
        perPage: number = 30,
        ref?: code_scanning_ref,
        sarifId?: code_scanning_analysis_sarif_id,
        direction: 'asc' | 'desc' = 'desc',
        sort: 'created' = 'created',
    ): CancelablePromise<Array<code_scanning_analysis>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningGetAnalysis(
        owner: string,
        repo: string,
        analysisId: number,
    ): CancelablePromise<code_scanning_analysis> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningDeleteAnalysis(
        owner: string,
        repo: string,
        analysisId: number,
        confirmDelete?: string | null,
    ): CancelablePromise<code_scanning_analysis_deletion> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static codeScanningListCodeqlDatabases(
        owner: string,
        repo: string,
    ): CancelablePromise<Array<code_scanning_codeql_database>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningGetCodeqlDatabase(
        owner: string,
        repo: string,
        language: string,
    ): CancelablePromise<code_scanning_codeql_database> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningGetDefaultSetup(
        owner: string,
        repo: string,
    ): CancelablePromise<code_scanning_default_setup> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static codeScanningUpdateDefaultSetup(
        owner: string,
        repo: string,
        requestBody: code_scanning_default_setup_update,
    ): CancelablePromise<empty_object | code_scanning_default_setup_update_response> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/repos/{owner}/{repo}/code-scanning/default-setup',
            path: {
     ...
     * @throws ApiError
     */
    public static codeScanningUploadSarif(
        owner: string,
        repo: string,
        requestBody: {
    ...
    ): CancelablePromise<code_scanning_sarifs_receipt> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static codeScanningGetSarif(
        owner: string,
        repo: string,
        sarifId: string,
    ): CancelablePromise<code_scanning_sarifs_status> {
        return __request(OpenAPI, {
            method: 'GET',
