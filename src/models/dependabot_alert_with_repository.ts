...
export type dependabot_alert_with_repository = {
     ...
     */
    readonly state: dependabot_alert_with_repository.state;
    /**
    ...
    readonly dependency: {
         ...
         */
        readonly scope?: dependabot_alert_with_repository.scope | null;
    };
     ...
     */
    dismissed_reason: dependabot_alert_with_repository.dismissed_reason | null;
    /**
...
export namespace dependabot_alert_with_repository {
