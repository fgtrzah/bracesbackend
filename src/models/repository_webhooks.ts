...
export type repository_webhooks = {
    ...
    template_repository?: {
         ...
         */
        squash_merge_commit_title?: repository_webhooks.squash_merge_commit_title;
        /**
         ...
         */
        squash_merge_commit_message?: repository_webhooks.squash_merge_commit_message;
        /**
         ...
         */
        merge_commit_title?: repository_webhooks.merge_commit_title;
        /**
         ...
         * - `BLANK` - default to a blank commit message.
         */
        merge_commit_message?: repository_webhooks.merge_commit_message;
...
export namespace repository_webhooks {
