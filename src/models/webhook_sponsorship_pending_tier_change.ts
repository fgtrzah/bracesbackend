...
export type webhook_sponsorship_pending_tier_change = {
    action: webhook_sponsorship_pending_tier_change.action;
    changes: {
        tier: {
            /**
    ...
    sponsorship: {
        ...
        sponsor: {
            ...
            starred_url?: string;
            subscriptions_url?: string;
            type?: webhook_sponsorship_pending_tier_change.type;
            url?: string;
        } | null;
        sponsorable: {
            avatar_url?: string;
...
export namespace webhook_sponsorship_pending_tier_change {
