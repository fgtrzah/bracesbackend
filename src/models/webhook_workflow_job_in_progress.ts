...
export type webhook_workflow_job_in_progress = {
    action: webhook_workflow_job_in_progress.action;
    ...
    workflow_job: ({
        ...
        conclusion: webhook_workflow_job_in_progress.conclusion | null;
        /**
         ...
         */
        status: webhook_workflow_job_in_progress.status;
        /**
...
export namespace webhook_workflow_job_in_progress {
