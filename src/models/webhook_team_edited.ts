...
export type webhook_team_edited = {
    action: webhook_team_edited.action;
    /**
    ...
    repository?: {
        ...
        updated_at: string;
        url: string;
        visibility: webhook_team_edited.visibility;
        watchers: number;
    ...
    team: {
        ...
        parent?: {
             ...
             */
            permission: string;
            privacy: webhook_team_edited.privacy;
            /**
             * Whether team members will receive notifications when their team is @mentioned
             */
            notification_setting: webhook_team_edited.notification_setting;
...
export namespace webhook_team_edited {
