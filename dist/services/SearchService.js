...
class SearchService {
     ...
     * @throws ApiError
     */
    static searchCode(q, sort, order = 'desc', perPage = 30, page = 1) {
     ...
     * @throws ApiError
     */
    static searchCommits(q, sort, order = 'desc', perPage = 30, page = 1) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/search/commits',
            query: {
     ...
     * @throws ApiError
     */
    static searchIssuesAndPullRequests(q, sort, order = 'desc', perPage = 30, page = 1) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/search/issues',
            query: {
     ...
     * @throws ApiError
     */
    static searchLabels(repositoryId, q, sort, order = 'desc', perPage = 30, page = 1) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/search/labels',
            query: {
     ...
     * @throws ApiError
     */
    static searchRepos(q, sort, order = 'desc', perPage = 30, page = 1) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static searchTopics(q, perPage = 30, page = 1) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/search/topics',
            query: {
     ...
     * @throws ApiError
     */
    static searchUsers(q, sort, order = 'desc', perPage = 30, page = 1) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/search/users',
            query: {
